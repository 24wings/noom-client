...
//     const topMenuUsed = this._theme.baseSettings.menu.position === "top";
//     const isRtl = rtlDetect.isRtlLang(abp.localization.currentLanguage.name);

//     let cssClass = "kt-page--" + this._theme.baseSettings.layout.layoutType + " kt-subheader--enabled kt-aside-left--offcanvas";
...
//       cssClass += " kt-subheader--" + this._theme.baseSettings.subHeader.subHeaderStyle;
...
//     if (topMenuUsed) {
//       cssClass += " kt-header--minimize-" + this._theme.baseSettings.header.minimizeDesktopHeaderType;
//     }
...
//     const menuCssClass = "m-header__bottom m-header-menu--skin-" + this._theme.baseSettings.menu.asideSkin + " m-container m-container--full-height m-container--responsive";
