...
export class LayoutProMenuComponent extends AppComponentBase implements OnInit, OnDestroy {
  ...
  constructor(private injector: Injector, private menuSrv: MenuService, private router: Router, public pro: BrandService, private cdr: ChangeDetectorRef) { super(injector); }
